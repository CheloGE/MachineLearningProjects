...
```
## An AWS EC2 instance for deep-learning was used to speed up the training process, 
   the following line allows to access the instances from a remote computer:
